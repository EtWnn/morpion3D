...
namespace Serveur.ModelGame
{
    ...
    /// <summary>
    /// <para></para>Handle the whole game party
    /// </summary>
    [Serializable]
    public class Game
    {
        ...
        /// <summary>
        /// Return a list of positions described by <see cref="Vector3"/> which forms a winning combinaison that includes the <paramref name="newPosition"/>
        /// </summary>
